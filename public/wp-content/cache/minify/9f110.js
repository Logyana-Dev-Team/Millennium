        ...
        [
          ...
          function (e, t) {
            ...
            for (var _ = 0, S = 0, w = []; S < f.length; ) {
              ...
              if (
                null === x ||
                (k = d(a(y.lastIndex + (h ? 0 : S)), f.length)) === _
              )
                S = s(f, S, g);
              else {
    ...
    e.exports = function (e, t, n, p, v, g, m) {
      ...
      if (
        (O &&
          ...
          _.next &&
          (u(_, w, !0), i || "function" == typeof _[d] || s(_, d, h)),
        k &&
          C &&
          "values" !== C.name &&
          ((x = !0),
  ...
  function (e, t, n) {
    ...
    var i = n(9),
      ...
      Y = function defineProperties(e, t) {
        y(e);
        for (var n, i = g((t = S(t))), r = 0, o = i.length; o > r; )
          Z(e, (n = i[r++]), t[n]);
        return e;
      },
